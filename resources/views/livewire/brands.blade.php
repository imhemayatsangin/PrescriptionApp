           ...
           <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
               <tr>
                   ...
                   <th scope="col" class="px-6 py-3">
                    <button class="font-semibold text-base " wire:click="sortBy('name')">  Brand Name</button>
        @if($sortBy=='name')
             ...
             <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
               ...
               {{ $brand->name }}
                ...
                <td class="px-6 py-4 text-right">
                    <x-jet-button wire:click="typeEditModal({{ $brand->id }})" class="bg-orange-500 hover:bg-orange-700">
                        {{ __('Edit') }}
                    </x-jet-button>
                    
                    <x-jet-danger-button wire:click="typedeletemodal({{ $brand->id }})" wire:loading.attr="disabled">
                        {{ __('Delete ') }}
                    </x-jet-danger-button>
           ...
           <x-jet-dialog-modal wire:model="typeconfimationmodal">
            ...
            <x-slot name="footer">
              ...
              <x-jet-dialog-modal wire:model="addingtypemodal">
                ...
                <x-slot name="title">
                    {{ isset($this->brand->id)? 'Edit Brand':'Add Brand'}}
                </x-slot>
                ...
                <x-slot name="content">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-jet-input id="name" type="text" class="mt-1 block w-full" wire:model.defer="brand.name" autocomplete="name" />
                        <x-jet-input-error for="brand.name" class="mt-2" />
                    </div>
    
                    <div class="col-span-6 sm:col-span-4 mt-4">
                        <x-jet-label for="description" value="{{ __('Description') }}" />
                        <x-jet-input id="description" type="text" class="mt-1 block w-full" wire:model.defer="brand.description"  />
                        <x-jet-input-error for="brand.description" class="mt-2" />
                    </div>
    
                    <div class="col-span-6 sm:col-span-4 mt-4">
                       
                        <x-jet-input id="status" type="checkbox" class="form-checkbox" wire:model.defer="brand.status"  />
